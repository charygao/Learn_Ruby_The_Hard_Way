...
puts "Your first variable is: #{file1}"
puts "Your second variable is: #{file2}"
puts "Your third variable is: #{file3}"
print "==============again \n"
puts "Your first variable is: #{ARGV.first} or #{$*[0]}"
puts "Your second variable is:#{ARGV[1]} or #{$*[1]}"
puts "Your third variable is:#{ARGV[2]} or #{$*[2]}"
